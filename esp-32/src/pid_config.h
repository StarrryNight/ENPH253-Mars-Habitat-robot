...
// on hardware.
#include "constants.h"
static constexpr double WHEEL_LEFT_PID_P = 80;
static constexpr double WHEEL_LEFT_PID_I = 40;
static constexpr double WHEEL_LEFT_PID_D = 1.0;
static constexpr double WHEEL_LEFT_PID_MAX_I = 400;

static constexpr double WHEEL_RIGHT_PID_P = 80;
static constexpr double WHEEL_RIGHT_PID_I = 40;
static constexpr double WHEEL_RIGHT_PID_D = 1.0;
static constexpr double WHEEL_RIGHT_PID_MAX_I = 400;

// the back wheel oscillates/overshoots.
static constexpr double WHEEL_BACK_PID_P = 80;
static constexpr double WHEEL_BACK_PID_I = 40;
static constexpr double WHEEL_BACK_PID_D = 1.0;
static constexpr double WHEEL_BACK_PID_MAX_I = 400;
...
static constexpr int VELOCITY_TO_PWM = 420;
...
static constexpr int WHEEL_BACK_VELOCITY_TO_PWM = 420;
