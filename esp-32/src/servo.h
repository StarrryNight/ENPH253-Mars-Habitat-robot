...
void setAngle(double servo_1_angle, double servo_2_angle);
	...
	static constexpr int SERVO_1_MIN_RAW = 1000;
	static constexpr int SERVO_1_MAX_RAW = 100;

	// Calibration (measured on hardware): forearm servo (ID 2), angle down
	// from horizontal.
	static constexpr double SERVO_2_MIN_DEG = 23.0;  // raw 2800, "high"
	static constexpr double SERVO_2_MAX_DEG = 70.0;  // raw 3300, "down"
	static constexpr int SERVO_2_MIN_RAW = 2800;
	static constexpr int SERVO_2_MAX_RAW = 3300;
};
