...
static constexpr int WHEEL_3_PWM_CHANNEL_0 = 0;
static constexpr int WHEEL_3_PWM_CHANNEL_1 = 1;

static constexpr int WHEEL_3_PWM_PIN_0 = 0;
static constexpr int WHEEL_3_PWM_PIN_1 = 1;
// Encoder
