...
static constexpr int WHEEL_1_ENCODER_1 = 0;
// "LEFT"

static constexpr int WHEEL_2_ENCODER_0 = 2;    // TODO: conflicts with WHEEL_3_ENCODER_0 — fix wiring
static constexpr int WHEEL_2_ENCODER_1 = 0;
// "BACK"

static constexpr int WHEEL_3_ENCODER_0 = 3;    // TODO: conflicts with WHEEL_2_ENCODER_0 — fix wiring
static constexpr int WHEEL_3_ENCODER_1 = 0;
// "RIGHT"

// Distance traveled per encoder tick (m). Set from wheel circumference / ticks-per-rev.
static constexpr double ENCODER_RESOLUTION_DISTANCE_M = 0.0009163; // at 70 mm diameter, 24 ticks-per-rev
